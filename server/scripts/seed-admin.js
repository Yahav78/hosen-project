...
dotenv_1.default.config({ path: '../.env' }); // Load from root
var seedAdmin = function () { return __awaiter(void 0, void 0, void 0, function () {
    var adminExists, salt, hashedPassword, admin, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, User_1.default.findOne({ username: 'yahav' })];
            case 2:
                adminExists = _a.sent();
                if (adminExists) {
            ...
            case 3:
                salt = _a.sent();
                return [4 /*yield*/, bcryptjs_1.default.hash('yv787878', salt)];
            case 4:
